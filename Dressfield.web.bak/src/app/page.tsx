...
export default async function HomePage() {
  ...
  const heroImages = products.flatMap((p) => (p.primaryImageUrl ? [p.primaryImageUrl] : []));
    ...
    <div className="flex-1">
      ...
      <section className="relative bg-black overflow-hidden">
        <div className="absolute inset-0">
          ...
          <HeroGalleryClient images={heroImages} count={8} className="z-10 opacity-60" />
        </div>

        {/* ── HERO CONTENT ──────────────────────────── */}
        <div className="pointer-events-none relative z-20 mx-auto flex min-h-[80vh] max-w-7xl flex-col items-center justify-center px-4 py-24 text-center sm:px-6 sm:py-32 lg:px-8">
