...
import { BadgePercent, ClipboardList, LayoutDashboard, Package, ShoppingBag, Scissors, LogOut } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/audit-log", label: "ჟურნალი", icon: ClipboardList },
];
